...
from llm_wrapper.llm import ChatResult, ToolChoice, ToolChoiceLiteral
from llm_wrapper.messages.chat_message import ChatMessage, Role, ToolCall, ChatMessageChunk, ToolCallChunk
...
def get_tool_choice_by_pydantic(pydantic_class: Type[BaseModel]) -> str | dict:
    return {"type": "function", "function": {"name": pydantic_class.model_json_schema()["title"]}}
